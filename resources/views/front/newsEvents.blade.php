                        ...
                        <div class="col-sm-3">
                            <div class="item item-light">
                                <div class="cursor-pointer" onclick="{!!"location.href='" . route('viewNews',['slug'=>$entry['slug']]) . "'"!!}">
                                    ...
                                    <b>{{str_limit(trans()->locale() == 'en' ? $entry['title'] : $entry['title_zh'],30)}}</b>
                            ...
                            <div class="item item-event">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <h2>{!! link_to_route('viewEvent',ucwords(str_limit(trans()->locale() == 'en' ? $entry->title : $entry->title_zh,30)),['slug'=>$entry->slug]) !!}</h2>
